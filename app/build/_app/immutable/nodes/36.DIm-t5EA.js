...
);`)),t(A,ae)};y(F,A=>{e(C)==="php"&&A(K)},!0)}t(H,U)};y(j,H=>{e(C)==="python"?H(z):H(W,!1)},!0)}t(v,J)};y(d,v=>{e(C)==="go"?v(l):v(x,!1)},!0)}t(m,n)};y(b,m=>{e(C)==="typescript"?m(I):m(O,!1)},!0)}t(i,f)};y(P,i=>{e(C)==="curl"?i(R):i(D,!1)})}a(p),t(E,h)},$$slots:{default:!0}}),a(V),t(Q,V)};y(X,Q=>{e(o)&&Q(he)},!0)}t(c,S)};y(_e,c=>{e(M)?c(ge):c(ye,!1)})}t(ue,Z),Te(),me()}export{dt as component};
