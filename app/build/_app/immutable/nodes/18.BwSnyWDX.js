...
apiRequest('POST', '/emails/send', [
    ...
    'subject' => 'Welcome!',
    'html' => '<h1>Hello</h1><p>Welcome to our service.</p>'
]);`);let we=w(()=>({curl:{code:e(be),language:"bash"},nodejs:{code:e($e),language:"javascript"},python:{code:e(Pe),language:"python"},go:{code:e(Ae),language:"go"},php:{code:e(Te),language:"php"}})),oe=w(()=>e(we)[e(J)]);Ye(async()=>{await re()});async function re(){c(O,!0),c(R,"");try{const t=await Ze();c(W,t.keys||[],!0)}catch{console.log("No API keys yet")}finally{c(O,!1)}}async function Ce(t){if(confirm("Are you sure you want to revoke this API key? This cannot be undone."))try{await et({},t),await re(),c(C,"API key revoked")}catch(P){c(R,P.message||"Failed to revoke API key",!0)}}function le(t){navigator.clipboard.writeText(t),c(E,t,!0),setTimeout(()=>c(E,""),2e3)}function ke(){c(D,!1),c(G,""),c(L,"")}function ne(t){return t?new Date(t).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):"Never"}var ce=yt();We("1vdl0tc",t=>{De(()=>{qe.title="API - Settings"})});var F=$(ce),ie=s(F);{var Ie=t=>{se(t,{type:"error",title:"Error",onclose:()=>c(R,""),children:(P,i)=>{var o=rt(),f=s(o,!0);a(o),te(()=>j(f,e(R))),l(P,o)},$$slots:{default:!0}})};S(ie,t=>{e(R)&&t(Ie)})}var de=r(ie,2);{var Se=t=>{se(t,{type:"success",title:"Success",onclose:()=>c(C,""),children:(P,i)=>{var o=lt(),f=s(o,!0);a(o),te(()=>j(f,e(C))),l(P,o)},$$slots:{default:!0}})};S(de,t=>{e(C)&&t(Se)})}var pe=r(de,2);q(pe,{children:(t,P)=>{var i=mt(),o=$(i),f=r(s(o),2);M(f,{type:"primary",size:"sm",onclick:()=>c(D,!0),children:(n,u)=>{var x=nt(),k=$(x);tt(k,{class:"mr-1.5 h-4 w-4"}),U(),l(n,x)},$$slots:{default:!0}}),a(o);var _=r(o,2);{var d=n=>{var u=ct(),x=s(u);Qe(x,{}),a(u),l(n,u)},m=n=>{var u=B(),x=$(u);{var k=h=>{var y=it(),g=s(y);at(g,{class:"mx-auto h-12 w-12 opacity-50"}),U(4),a(y),l(h,y)},K=h=>{var y=pt(),g=s(y),b=r(s(g));Ne(b,21,()=>e(W),Y=>Y.id,(Y,I)=>{var A=dt(),V=s(A),Ke=s(V,!0);a(V);var X=r(V),Ue=s(X);a(X);var Q=r(X),je=s(Q,!0);a(Q);var Z=r(Q),Oe=s(Z,!0);a(Z);var ve=r(Z),Le=s(ve);M(Le,{type:"danger",size:"icon",onclick:()=>Ce(e(I).id),children:(ee,fe)=>{st(ee,{class:"h-4 w-4"})},$$slots:{default:!0}}),a(ve),a(A),te((ee,fe)=>{j(Ke,e(I).name),j(Ue,`${e(I).key_prefix??""}...`),j(je,ee),j(Oe,fe)},[()=>ne(e(I).last_used),()=>ne(e(I).created_at)]),l(Y,A)}),a(b),a(g),a(y),l(h,y)};S(x,h=>{e(W).length===0?h(k):h(K,!1)},!0)}l(n,u)};S(_,n=>{e(O)?n(d):n(m,!1)})}l(t,i)},$$slots:{default:!0}});var me=r(pe,2);q(me,{children:(t,P)=>{var i=ut(),o=$(i),f=s(o);Ve(f,{class:"h-5 w-5 text-primary"}),U(2),a(o);var _=r(o,2),d=s(_),m=r(s(d),2),n=s(m);ae(n,{type:"text",get value(){return e(v)},readonly:!0,class:"font-mono text-sm"});var u=r(n,2);M(u,{type:"secondary",onclick:()=>le(e(v)),children:(x,k)=>{var K=B(),h=$(K);{var y=b=>{_e(b,{class:"h-4 w-4 text-green-500"})},g=b=>{ye(b,{class:"h-4 w-4"})};S(h,b=>{e(E)===e(v)?b(y):b(g,!1)})}l(x,K)},$$slots:{default:!0}}),a(m),a(d),U(2),a(_),l(t,i)},$$slots:{default:!0}});var ue=r(me,2);q(ue,{children:(t,P)=>{var i=vt(),o=r($(i),2),f=s(o);Xe(f,{get tabs(){return ge},variant:"pills",get activeTab(){return e(J)},set activeTab(d){c(J,d,!0)}}),a(o);var _=r(o,2);he(_,{get code(){return e(oe).code},get language(){return e(oe).language}}),l(t,i)},$$slots:{default:!0}});var Re=r(ue,2);q(Re,{children:(t,P)=>{var i=ft(),o=$(i),f=s(o);ot(f,{class:"h-5 w-5 text-primary"}),U(2),a(o);var _=r(o,4),d=r(s(_),2);{let m=w(()=>`import { Outlet } from '@outlet/sdk';
...
console.log('Message ID:', result.message_id);`);he(d,{get code(){return e(m)},language:"typescript"})}a(_),l(t,i)},$$slots:{default:!0}}),a(F);var Ee=r(F,2);Fe(Ee,{title:"Create API Key",onclose:ke,get show(){return e(D)},set show(t){c(D,t,!0)},children:(t,P)=>{var i=B(),o=$(i);{var f=d=>{var m=ht(),n=s(m);se(n,{type:"warning",title:"Save your API key",children:(h,y)=>{var g=xt();l(h,g)},$$slots:{default:!0}});var u=r(n,2),x=r(s(u),2),k=s(x);ae(k,{type:"text",get value(){return e(L)},readonly:!0,class:"font-mono text-sm"});var K=r(k,2);M(K,{type:"secondary",onclick:()=>le(e(L)),children:(h,y)=>{var g=B(),b=$(g);{var Y=A=>{_e(A,{class:"h-4 w-4 text-green-500"})},I=A=>{ye(A,{class:"h-4 w-4"})};S(b,A=>{e(E)===e(L)?A(Y):A(I,!1)})}l(h,g)},$$slots:{default:!0}}),a(x),a(u),a(m),l(d,m)},_=d=>{var m=_t(),n=s(m),u=r(s(n),2);ae(u,{type:"text",id:"key-name",placeholder:"e.g., Production API, Development",get value(){return e(G)},set value(x){c(G,x,!0)}}),U(2),a(n),a(m),l(d,m)};S(o,d=>{e(L)?d(f):d(_,!1)})}l(t,i)},$$slots:{default:!0}}),l(z,ce),He()}export{jt as component};
