...
apiRequest('POST', '/emails/send', [
    ...
    'subject' => 'Welcome!',
    'html' => '<h1>Hello</h1><p>Welcome to our service.</p>'
]);`);let Ie=k(()=>({curl:{code:e(Ae),language:"bash"},nodejs:{code:e(we),language:"javascript"},python:{code:e(Ce),language:"python"},go:{code:e(Te),language:"go"},php:{code:e(ke),language:"php"}})),ce=k(()=>e(Ie)[e(X)]);qe(async()=>{await Q()});async function Q(){n(Y,!0),n(A,"");try{const t=await at();n(V,t.keys||[],!0)}catch{console.log("No API keys yet")}finally{n(Y,!1)}}async function Se(){if(!e(L).trim()){n(A,"Please enter a name for the API key");return}n(B,!0),n(A,"");try{const t=await ot({name:e(L).trim()});n(E,t.key||"",!0),await Q(),n(K,"API key created successfully. Copy it now - you won't be able to see it again!")}catch(t){n(A,t.message||"Failed to create API key",!0)}finally{n(B,!1)}}async function Re(t){if(confirm("Are you sure you want to revoke this API key? This cannot be undone."))try{await st({},t),await Q(),n(K,"API key revoked")}catch(f){n(A,f.message||"Failed to revoke API key",!0)}}function ie(t){navigator.clipboard.writeText(t),n(z,t,!0),setTimeout(()=>n(z,""),2e3)}function Z(){n(N,!1),n(L,""),n(E,"")}function de(t){return t?new Date(t).toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}):"Never"}var pe=wt();Je("1kyawqp",t=>{ze(()=>{Ne.title="API - Settings"})});var ee=P(pe),me=o(ee);{var Ke=t=>{ne(t,{type:"error",title:"Error",onclose:()=>n(A,""),children:(f,d)=>{var a=it(),x=o(a,!0);s(a),W(()=>j(x,e(A))),l(f,a)},$$slots:{default:!0}})};R(me,t=>{e(A)&&t(Ke)})}var ue=r(me,2);{var Ee=t=>{ne(t,{type:"success",title:"Success",onclose:()=>n(K,""),children:(f,d)=>{var a=dt(),x=o(a,!0);s(a),W(()=>j(x,e(K))),l(f,a)},$$slots:{default:!0}})};R(ue,t=>{e(K)&&t(Ee)})}var ve=r(ue,2);F(ve,{children:(t,f)=>{var d=xt(),a=P(d),x=r(o(a),2);O(x,{type:"primary",size:"sm",onclick:()=>n(N,!0),children:(c,i)=>{var u=pt(),$=P(u);rt($,{class:"mr-1.5 h-4 w-4"}),I(),l(c,u)},$$slots:{default:!0}}),s(a);var _=r(a,2);{var m=c=>{var i=mt(),u=o(i);tt(u,{}),s(i),l(c,i)},p=c=>{var i=D(),u=P(i);{var $=g=>{var b=ut(),S=o(b);lt(S,{class:"mx-auto h-12 w-12 opacity-50"}),I(4),s(b),l(g,b)},w=g=>{var b=ft(),S=o(b),y=r(o(S));Ge(y,21,()=>e(V),H=>H.id,(H,U)=>{var q=vt(),C=o(q),Oe=o(C,!0);s(C);var te=r(C),Le=o(te);s(te);var ae=r(te),Ye=o(ae,!0);s(ae);var se=r(ae),Be=o(se,!0);s(se);var ye=r(se),He=o(ye);O(He,{type:"danger",size:"icon",onclick:()=>Re(e(U).id),children:(oe,he)=>{nt(oe,{class:"h-4 w-4"})},$$slots:{default:!0}}),s(ye),s(q),W((oe,he)=>{j(Oe,e(U).name),j(Le,`${e(U).key_prefix??""}...`),j(Ye,oe),j(Be,he)},[()=>de(e(U).last_used),()=>de(e(U).created_at)]),l(H,q)}),s(y),s(S),s(b),l(g,b)};R(u,g=>{e(V).length===0?g($):g(w,!1)},!0)}l(c,i)};R(_,c=>{e(Y)?c(m):c(p,!1)})}l(t,d)},$$slots:{default:!0}});var fe=r(ve,2);F(fe,{children:(t,f)=>{var d=yt(),a=P(d),x=o(a);Ze(x,{class:"h-5 w-5 text-primary"}),I(2),s(a);var _=r(a,2),m=o(_),p=r(o(m),2),c=o(p);le(c,{type:"text",get value(){return e(h)},readonly:!0,class:"font-mono text-sm"});var i=r(c,2);O(i,{type:"secondary",onclick:()=>ie(e(h)),children:(u,$)=>{var w=D(),g=P(w);{var b=y=>{be(y,{class:"h-4 w-4 text-green-500"})},S=y=>{$e(y,{class:"h-4 w-4"})};R(g,y=>{e(z)===e(h)?y(b):y(S,!1)})}l(u,w)},$$slots:{default:!0}}),s(p),s(m),I(2),s(_),l(t,d)},$$slots:{default:!0}});var xe=r(fe,2);F(xe,{children:(t,f)=>{var d=ht(),a=r(P(d),2),x=o(a);et(x,{get tabs(){return Pe},variant:"pills",get activeTab(){return e(X)},set activeTab(m){n(X,m,!0)}}),s(a);var _=r(a,2);ge(_,{get code(){return e(ce).code},get language(){return e(ce).language}}),l(t,d)},$$slots:{default:!0}});var Ue=r(xe,2);F(Ue,{children:(t,f)=>{var d=_t(),a=P(d),x=o(a);ct(x,{class:"h-5 w-5 text-primary"}),I(2),s(a);var _=r(a,4),m=r(o(_),2);{let p=k(()=>`import { Outlet } from '@outlet/sdk';
...
console.log('Message ID:', result.message_id);`);ge(m,{get code(){return e(p)},language:"typescript"})}s(_),l(t,d)},$$slots:{default:!0}}),s(ee);var je=r(ee,2);Qe(je,{title:"Create API Key",onclose:Z,get show(){return e(N)},set show(f){n(N,f,!0)},footer:f=>{var d=bt(),a=o(d);{var x=m=>{O(m,{type:"primary",onclick:Z,children:(p,c)=>{I();var i=re("Done");l(p,i)},$$slots:{default:!0}})},_=m=>{var p=gt(),c=P(p);O(c,{type:"secondary",onclick:Z,children:(u,$)=>{I();var w=re("Cancel");l(u,w)},$$slots:{default:!0}});var i=r(c,2);{let u=k(()=>e(B)||!e(L).trim());O(i,{type:"primary",onclick:Se,get disabled(){return e(u)},children:($,w)=>{I();var g=re();W(()=>j(g,e(B)?"Creating...":"Create Key")),l($,g)},$$slots:{default:!0}})}l(m,p)};R(a,m=>{e(E)?m(x):m(_,!1)})}s(d),l(f,d)},children:(f,d)=>{var a=D(),x=P(a);{var _=p=>{var c=Pt(),i=o(c);ne(i,{type:"warning",title:"Save your API key",children:(b,S)=>{var y=$t();l(b,y)},$$slots:{default:!0}});var u=r(i,2),$=r(o(u),2),w=o($);le(w,{type:"text",get value(){return e(E)},readonly:!0,class:"font-mono text-sm"});var g=r(w,2);O(g,{type:"secondary",onclick:()=>ie(e(E)),children:(b,S)=>{var y=D(),H=P(y);{var U=C=>{be(C,{class:"h-4 w-4 text-green-500"})},q=C=>{$e(C,{class:"h-4 w-4"})};R(H,C=>{e(z)===e(E)?C(U):C(q,!1)})}l(b,y)},$$slots:{default:!0}}),s($),s(u),s(c),l(p,c)},m=p=>{var c=At(),i=o(c),u=r(o(i),2);le(u,{type:"text",id:"key-name",placeholder:"e.g., Production API, Development",get value(){return e(L)},set value($){n(L,$,!0)}}),I(2),s(i),s(c),l(p,c)};R(x,p=>{e(E)?p(_):p(m,!1)})}l(f,a)},$$slots:{footer:!0,default:!0}}),l(G,pe),Me()}export{qt as component};
