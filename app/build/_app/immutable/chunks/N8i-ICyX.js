...
}`;async function E(){await navigator.clipboard.writeText(T),O(b,!0),setTimeout(()=>O(b,!1),2e3)}var g=q(),V=d(g);{var j=o=>{var f=J(),S=e(f),c=e(S),p=e(c);R(p,{class:"w-4 h-4 text-amber-500"}),a(2),t(c);var i=m(c,2);i.__click=E;var _=e(i);{var v=n=>{var s=W(),y=d(s);U(y,{class:"w-3 h-3"}),a(),r(n,s)},w=n=>{var s=H(),y=d(s);B(y,{class:"w-3 h-3"}),a(),r(n,s)};C(_,n=>{P(b)?n(v):n(w,!1)})}t(i),t(S);var A=m(S,4);A.textContent=`{
  "Version": "2012-10-17",
  "Statement": [
    {
      "Sid": "OutletSESPermissions",
...
}`,t(f),r(o,f)},Y=o=>{Q(o,{children:(f,S)=>{var c=$(),p=d(c),i=e(p),_=e(i);R(_,{class:"w-5 h-5 text-amber-500"}),a(2),t(i);var v=m(i,2);v.__click=E;var w=e(v);{var A=l=>{var x=X(),h=d(x);U(h,{class:"w-4 h-4"}),a(),r(l,x)},n=l=>{var x=Z(),h=d(x);B(h,{class:"w-4 h-4"}),a(),r(l,x)};C(w,l=>{P(b)?l(A):l(n,!1)})}t(v),t(p);var s=m(p,4),y=e(s);y.textContent=`{
  "Version": "2012-10-17",
  "Statement": [
    {
      "Sid": "OutletSESPermissions",
...
}`,t(s);var k=m(s,2),I=e(k),F=m(e(I));z(F,{class:"w-3 h-3"}),t(I),a(2),t(k),r(f,c)},$$slots:{default:!0}})};C(V,o=>{G()?o(j):o(Y,!1)})}r(D,g)}M(["click"]);export{ce as A};
