...
<svelte:head>
	<title>Site Settings - {org?.name || 'Loading'}</title>
</svelte:head>
		...
		<Card>
			<h2 class="text-lg font-medium text-text mb-4">General</h2>
				...
				<Card>
					...
					<p class="text-sm text-text-muted mb-4">Use this key to authenticate API requests for this site.</p>
...
<AlertDialog
	...
	title="Delete Site"
	description={`Are you sure you want to delete ${org?.name}? This will permanently delete all associated data including contacts, leads, and orders. This action cannot be undone.`}
