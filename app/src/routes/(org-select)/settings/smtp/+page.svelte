...
<div class="space-y-6">
	<Alert type="info" title="SMTP Ingress">
		...
		<p class="mt-2 text-sm">
			<strong>Workspace scoping:</strong> Your API key determines which workspace/organization emails
			are sent from. If you have multiple workspaces, create separate API keys for each.
		</p>
	</Alert>
				...
				<tbody class="divide-y divide-border/50">
					<tr>
						...
						<td class="py-3 text-text-muted">
							<strong>Required.</strong> Organization/workspace slug to send emails from. Get this from your workspace URL.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="py-3"><code class="text-xs bg-surface-tertiary px-1 rounded">slug</code></td>
						<td class="py-3 text-text-muted">
							Associate email with a list (for marketing). List slug is scoped to your workspace.
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="py-3"><code class="text-xs bg-surface-tertiary px-1 rounded">slug</code></td>
						<td class="py-3 text-text-muted">
							Use a predefined email template. Template slug is scoped to your workspace.
						</td>
					</tr>
					<tr>
